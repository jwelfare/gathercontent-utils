...
const getItem = (itemId, params, credentials) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const itemContent = itemData.structure.groups.reduce((acc, group) => (Object.assign(Object.assign({}, acc), { [(0, generateSlug_1.createSlug)(group.name, acc, true)]: (0, reduceFields_1.reduceFields)(itemData.content, group.fields) })), {});
